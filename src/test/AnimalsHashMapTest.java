...
public class AnimalsHashMapTest
{
    ...
    {
        AnimalsHashMap animalsHashMap = new AnimalsHashMap();
        ...
        Assert.assertEquals(new LinkedList<Animal>(Arrays.asList(animals.get(2), animals.get(7))), animalsHashMap.getAnimalsToBreed(new Vector2d(3, 1)));
        ...
        Assert.assertEquals(new LinkedList<Animal>(Arrays.asList(animals.get(3), animals.get(2))), animalsHashMap.getAnimalsToBreed(new Vector2d(3, 1)));
    }
}
