...
public class AnimalsHashMapTest
{
    ...
    public void animalsHashMapTest()
    {
        ...
        Assert.assertEquals(new LinkedList<>(Arrays.asList(animals.get(2))), animalsHashMap.getAnimalsToEat(new Vector2d(3, 1)));
        Assert.assertNull(animalsHashMap.getAnimalsToEat(new Vector2d(8, 10)));

        Assert.assertEquals(new LinkedList<>(Arrays.asList(animals.get(2), animals.get(6))), animalsHashMap.getAnimalsToBreed(new Vector2d(3, 1)));
        ...
        Assert.assertEquals(new LinkedList<>(Arrays.asList(animals.get(2), animals.get(7), animals.get(8))), animalsHashMap.getAnimalsToEat(new Vector2d(3, 1)));

        Assert.assertEquals(new LinkedList<>(Arrays.asList(animals.get(2), animals.get(8))), animalsHashMap.getAnimalsToBreed(new Vector2d(3, 1)));

        animals.get(3).changePosition(new Vector2d(3, 1));
        animalsHashMap.updatePosition(new Vector2d(4, 0), animals.get(3));

        Assert.assertEquals(new LinkedList<>(Arrays.asList(animals.get(3))), animalsHashMap.getAnimalsToEat(new Vector2d(3, 1)));
        Assert.assertNull(animalsHashMap.getAnimalsToEat(new Vector2d(4, 0)));

        Assert.assertEquals(new LinkedList<>(Arrays.asList(animals.get(3), animals.get(7))), animalsHashMap.getAnimalsToBreed(new Vector2d(3, 1)));
